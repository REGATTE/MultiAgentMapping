...
public:
    ...
    rclcpp::Subscription<multi_agent_mapping::msg::CloudInfo>::SharedPtr subLaserCloudInfo;

    rclcpp::Publisher<multi_agent_mapping::msg::CloudInfo>::SharedPtr pubLaserCloudInfo;
    ...
    {
        subLaserCloudInfo = create_subscription<multi_agent_mapping::msg::CloudInfo>(
            "lio_sam/deskew/cloud_info", qos,
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1));

        pubLaserCloudInfo = create_publisher<multi_agent_mapping::msg::CloudInfo>(
