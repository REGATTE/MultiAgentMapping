...
class distributedMapping : public paramsServer{
    ...
    private:
        ...
        pcl::PointCloud<PointPose3D>::Ptr cloud_for_descript_ds;
        ...
        rclcpp::TimerBase::SharedPtr distributed_mapping_timer_; // timer for running distributed mapping
