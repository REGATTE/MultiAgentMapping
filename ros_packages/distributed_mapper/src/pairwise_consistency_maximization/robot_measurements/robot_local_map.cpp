...
namespace robot_measurements {
    RobotLocalMap::RobotLocalMap(const graph_utils::Transforms& transforms, const graph_utils::LoopClosures& loop_closures):  RobotMeasurements(transforms, loop_closures) {
            trajectory_ = graph_utils::buildTrajectory(transforms_);
        }
    
    RobotLocalMap::RobotLocalMap(const graph_utils::Trajectory& trajectory, const graph_utils::Transforms& transforms, const graph_utils::LoopClosures& loop_closures): RobotMeasurements(transforms, loop_closures){
